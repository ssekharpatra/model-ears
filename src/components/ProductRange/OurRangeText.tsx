      ...
      return (
         <div className="absolute top-0 left-0 w-full flex justify-center pointer-events-none z-0 overflow-hidden">
            <div
               ...
               aria-hidden="true"
               role="presentation"
               className="text-[14vw] md:text-[15vw] lg:text-[14rem] font-bold text-light-gray uppercase tracking-[0.01em] leading-none whitespace-nowrap select-none font-schein opacity-0 translate-y-[300px]"
            >
               OUR RANGE
            </div>
         </div>
