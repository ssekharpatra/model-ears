  ...
  function Carousel({ carousel, onPrev, onNext, onMouseMove, onMouseEnter, onMouseLeave }, ref) {
    ...
    return (
      ...
      >
        ...
        <div className="w-full px-2 md:px-12 pt-12 md:pt-[8rem] pb-6 md:pb-8 invisible pointer-events-none opacity-0 flex justify-center">
        ...
        <div
          className="absolute inset-0 w-full px-2 md:px-12 pt-12 md:pt-[8rem] pb-6 md:pb-8 flex items-center justify-between gap-2 sm:gap-6 md:gap-[15%]"
          aria-live="polite"
        >
