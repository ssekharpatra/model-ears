 ...
 * Act 2 of hero entrance: animated via parent GSAP timeline.
 */
export const HeroLogo = forwardRef<HTMLDivElement>(
   function HeroLogo(_, ref) {
      return (
         <div
            ref={ref}
            className="w-full flex justify-center items-center pt-10 z-20"
            style={{ opacity: 0 }}
         >
