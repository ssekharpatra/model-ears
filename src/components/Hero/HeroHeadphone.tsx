      ...
      >
         ...
         >
            <div
               ...
               style={{ opacity: 0 }}
            >
               {/* Mobile & Tablet: full headphone image */}
               <Image
                  ...
                  height={803}
                  priority
                  sizes="(max-width: 1380px) 75vw, 50vw"
                  className="min-[1381px]:hidden absolute top-1/2 left-1/2
              -translate-x-[50%] md:-translate-x-[69%] lg:-translate-x-[63%]
              -translate-y-[50%]
              h-[70%] md:h-[95%] lg:h-[105%]
              ...
              pointer-events-none"
               ...
               <Image
                  ...
                  priority
                  sizes="50vw"
                  className="hidden min-[1381px]:block absolute top-1/2 left-1/2
              -translate-x-[60%]
              -translate-y-[48%]
              h-[125%]
              w-auto max-w-none object-contain
